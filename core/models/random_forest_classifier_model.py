...
class RandomForestClassifierModel(BaseModel):
    ...
    def visualize_tree(
        self, output_path: str = "outputs/random_forest_trees.png", figsize=(20, 10)
    ):
        """視覺化隨機森林中的第一棵樹"""
        ...
        plt.title(
            "First Tree in Random Forest for Titanic Survival Prediction",
            fontsize=16,
            pad=20,
        )
        plt.tight_layout()
        ...
        print(f"✅ 隨機森林第一棵樹視覺化已儲存至 {output_path}")
